...
def My_Order():
    ...
    sleep(0.3)
    assert driver.find_element(By.XPATH,"//label[normalize-space()='- No orders -']").is_displayed()
    print('- No orders - is displayed')
    sleep(0.4)
    driver.find_element(By.XPATH,"//span[normalize-space()='dvantage']").click()
...
def Del_Acnt():
    ...
    sleep(0.3)
    assert driver.find_element(By.XPATH, "//div[@id='myAccountContainer']//div[1]//div[1]//div[1]//label[1]").is_displayed()
    print(f'account holder is: {locators.username}')
